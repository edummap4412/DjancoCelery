...
- :exc:`Exception`
    - :exc:`celeryapp.exceptions.CeleryError`
        - :exc:`~celeryapp.exceptions.ImproperlyConfigured`
        - :exc:`~celeryapp.exceptions.SecurityError`
        - :exc:`~celeryapp.exceptions.TaskPredicate`
            - :exc:`~celeryapp.exceptions.Ignore`
            - :exc:`~celeryapp.exceptions.Reject`
            - :exc:`~celeryapp.exceptions.Retry`
        - :exc:`~celeryapp.exceptions.TaskError`
            - :exc:`~celeryapp.exceptions.QueueNotFound`
            - :exc:`~celeryapp.exceptions.IncompleteStream`
            - :exc:`~celeryapp.exceptions.NotRegistered`
            - :exc:`~celeryapp.exceptions.AlreadyRegistered`
            - :exc:`~celeryapp.exceptions.TimeoutError`
            - :exc:`~celeryapp.exceptions.MaxRetriesExceededError`
            - :exc:`~celeryapp.exceptions.TaskRevokedError`
            - :exc:`~celeryapp.exceptions.InvalidTaskError`
            - :exc:`~celeryapp.exceptions.ChordError`
        - :exc:`~celeryapp.exceptions.BackendError`
            - :exc:`~celeryapp.exceptions.BackendGetMetaError`
            - :exc:`~celeryapp.exceptions.BackendStoreError`
    - :class:`kombu.exceptions.KombuError`
        - :exc:`~celeryapp.exceptions.OperationalError`
    ...
    - **billiard errors** (prefork pool)
        - :exc:`~celeryapp.exceptions.SoftTimeLimitExceeded`
        - :exc:`~celeryapp.exceptions.TimeLimitExceeded`
        - :exc:`~celeryapp.exceptions.WorkerLostError`
        - :exc:`~celeryapp.exceptions.Terminated`
- :class:`UserWarning`
    - :class:`~celeryapp.exceptions.CeleryWarning`
        - :class:`~celeryapp.exceptions.AlwaysEagerIgnored`
        - :class:`~celeryapp.exceptions.DuplicateNodenameWarning`
        - :class:`~celeryapp.exceptions.FixupWarning`
        - :class:`~celeryapp.exceptions.NotConfigured`
        - :class:`~celeryapp.exceptions.SecurityWarning`
- :exc:`BaseException`
    - :exc:`SystemExit`
        - :exc:`~celeryapp.exceptions.WorkerTerminate`
        - :exc:`~celeryapp.exceptions.WorkerShutdown`
"""
