...
# :copyright: (c) 2016-2026 Asif Saif Uddin, celeryapp core and individual
...
old_module, new_module = local.recreate_module(  # pragma: no cover
    __name__,
    by_module={
        'celeryapp.app': ['Celery', 'bugreport', 'shared_task'],
        'celeryapp.app.task': ['Task'],
        'celeryapp._state': ['current_app', 'current_task'],
        'celeryapp.canvas': [
            'Signature', 'chain', 'chord', 'chunks', 'group',
            'signature', 'maybe_signature', 'subtask',
            'xmap', 'xstarmap',
        ],
        'celeryapp.utils': ['uuid'],
    },
    __package__='celeryapp', __file__=__file__,
