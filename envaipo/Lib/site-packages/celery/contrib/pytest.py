...
def pytest_configure(config):
    ...
    # add the pytest.mark.celeryapp() marker registration to the pytest.ini [markers] section
    ...
    config.addinivalue_line(
        "markers", "celeryapp(**overrides): override celeryapp configuration for a test case"
    )
...
def celery_session_app(request,
    ...
    mark = request.node.get_closest_marker('celeryapp')
...
def celery_parameters():
    ...
    as parameters when instantiating :class:`~celeryapp.Celery`.
    """
    return {}
...
def celery_worker_parameters():
    ...
    The dict returned by your fixture will then be used
    as parameters when instantiating :class:`~celeryapp.worker.WorkController`.
    """
    return {}
