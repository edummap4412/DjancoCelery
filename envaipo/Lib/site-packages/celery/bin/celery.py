...
Unable to load celeryapp application.
...
@with_plugins(iter_entry_points('celeryapp.commands'))
...
def main() -> int:
    """Start celeryapp umbrella command.
