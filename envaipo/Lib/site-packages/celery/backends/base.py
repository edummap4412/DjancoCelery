...
class Backend:
    ...
    def fallback_chord_unlock(self, header_result, body, countdown=1,
        ...
        self.app.tasks['celeryapp.chord_unlock'].apply_async(
...
class SyncBackendMixin:
    ...
    def wait_for(self, task_id,
        ...
        Raises:
            celeryapp.exceptions.TimeoutError:
...
class BaseKeyValueStoreBackend(Backend):
    key_t = ensure_bytes
    task_keyprefix = 'celeryapp-task-meta-'
    group_keyprefix = 'celeryapp-taskset-meta-'
