...
.. seealso:
    ...
    You should import these from :mod:`celeryapp` and not this module.
"""
...
class Signature(dict):
    ...
    Note:
        You should use :func:`~celeryapp.signature` to create new signatures.
    ...
    Arguments:
        task (Union[Type[celeryapp.app.task.Task], str]): Either a task
...
class _chain(Signature):
    ...
    def __init__(self, *tasks, **options):
        ...
        super().__init__('celeryapp.chain', (), {'tasks': tasks}, **options
                         )
...
class chain(_chain):
    ...
    Returns:
        ~celeryapp.chain: A lazy signature that can be called to apply the first
...
class chunks(Signature):
    ...
    def __init__(self, task, it, n, **options):
        super().__init__('celeryapp.chunks', (),
...
class group(Signature):
    ...
    Returns:
        ~celeryapp.group: signature that when called will then call all of the
    ...
    def __init__(self, *tasks, **options):
        if len(tasks) == 1:
            ...
            if not isinstance(tasks, _regen):
                tasks = regen(tasks)
        super().__init__('celeryapp.group', (), {'tasks': tasks}, **options
                         )
...
class _chord(Signature):
    ...
    def __init__(self, header, body=None, task='celeryapp.chord',
