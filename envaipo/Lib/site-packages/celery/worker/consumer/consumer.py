...
class Consumer:
    ...
    class Blueprint(bootsteps.Blueprint):
        ...
        name = 'Consumer'
        default_steps = [
            'celeryapp.worker.consumer.connection:Connection',
            'celeryapp.worker.consumer.mingle:Mingle',
            'celeryapp.worker.consumer.events:Events',
            'celeryapp.worker.consumer.gossip:Gossip',
            'celeryapp.worker.consumer.heart:Heart',
            'celeryapp.worker.consumer.control:Control',
            'celeryapp.worker.consumer.tasks:Tasks',
            'celeryapp.worker.consumer.consumer:Evloop',
            'celeryapp.worker.consumer.agent:Agent',
        ]
    ...
    def _update_prefetch_count(self, index=0):
        ...
        Note:
            ...
            :option:`--autoscale=1,0 <celeryapp worker --autoscale>`).
        """
