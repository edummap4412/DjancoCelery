...
The command-line interface for the worker is in :mod:`celeryapp.bin.worker`,
while the worker program is in :mod:`celeryapp.apps.worker`.
...
class WorkController:
    ...
    class Blueprint(bootsteps.Blueprint):
        ...
        name = 'Worker'
        default_steps = {
            'celeryapp.worker.components:Hub',
            'celeryapp.worker.components:Pool',
            'celeryapp.worker.components:Beat',
            'celeryapp.worker.components:Timer',
            'celeryapp.worker.components:StateDB',
            'celeryapp.worker.components:Consumer',
            'celeryapp.worker.autoscale:WorkerComponent',
        }
