...
RESERVED_LOGGER_NAMES = {'celeryapp', 'celeryapp.task'}

# Sets up our logging hierarchy.
#
# Every logger in the celeryapp package inherits from the "celeryapp"
# logger, and every task logger inherits from the "celeryapp.task"
# logger.
base_logger = logger = _get_logger('celeryapp')
...
task_logger = get_logger('celeryapp.task')
worker_logger = get_logger('celeryapp.worker')
