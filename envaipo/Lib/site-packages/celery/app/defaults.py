...
NAMESPACES = Namespace(
    ...
    beat=Namespace(
        ...
        scheduler=Option('celeryapp.beat:PersistentScheduler'),
    ...
    azureblockblob=Namespace(
        container_name=Option('celeryapp', type='string'),
    ...
    control=Namespace(
        ...
        exchange=Option('celeryapp', type='string'),
    ),
    couchbase=Namespace(
    ...
    task=Namespace(
        ...
        default_queue=Option('celeryapp'),
    ...
    worker=Namespace(
        ...
        autoscaler=Option('celeryapp.worker.autoscale:Autoscaler'),
        cancel_long_running_tasks_on_connection_loss=Option(
            False, type='bool'
        ),
        concurrency=Option(None, type='int'),
        consumer=Option('celeryapp.worker.consumer:Consumer', type='string'),
...
def find(name, namespace='celeryapp'):
