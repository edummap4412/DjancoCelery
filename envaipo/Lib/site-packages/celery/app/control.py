...
Server implementation is in :mod:`celeryapp.worker.control`.
...
class Inspect:
    ...
    defined in :py:mod:`celeryapp.worker.control`
    """
    ...
    def revoked(self):
        ...
        {'celeryapp@node1': ['16f527de-1c72-47a6-b477-c472b92fef7a']}
    ...
    def registered(self, *taskinfoitems):
        ...
        {'celeryapp@node1': ['task1', 'task1']}
        >>> app.control.inspect().registered('serializer', 'max_retries')
        {'celeryapp@node1': ['task_foo [serializer=json max_retries=3]', 'tasb_bar [serializer=json max_retries=3]']}

        Arguments:
            taskinfoitems (Sequence[str]): List of :class:`~celeryapp.app.task.Task`
    ...
    def ping(self, destination=None):
        ...
        {'celeryapp@node1': {'ok': 'pong'}, 'celeryapp@node2': {'ok': 'pong'}}
        >>> app.control.inspect().ping(destination=['celeryapp@node1'])
        {'celeryapp@node1': {'ok': 'pong'}}
...
class Control:
    ...
    def ping(self, destination=None, timeout=1.0, **kwargs):
        ...
        >>> app.control.ping()
        [{'celeryapp@node1': {'ok': 'pong'}}, {'celeryapp@node2': {'ok': 'pong'}}]
        >>> app.control.ping(destination=['celeryapp@node2'])
        [{'celeryapp@node2': {'ok': 'pong'}}]
    ...
    def rate_limit(self, task_name, rate_limit, destination=None, **kwargs):
        ...
        Arguments:
            ...
            rate_limit (int, str): The rate limit as tasks per second,
                ...
                see :attr:`celeryapp.app.task.Task.rate_limit` for
                more information).
    ...
    def broadcast(self, command, arguments=None, destination=None,
                  ...
                  **extra_kwargs):
        """Broadcast a control command to the celeryapp workers.
