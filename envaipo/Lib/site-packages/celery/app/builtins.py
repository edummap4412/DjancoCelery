...
def add_backend_cleanup_task(app):
    ...
    :program:`celeryapp beat` to be running).
    """
    @app.task(name='celeryapp.backend_cleanup', shared=False, lazy=False)
    def backend_cleanup():
        app.backend.cleanup()
...
def add_accumulate_task(app):
    ...
    @app.task(bind=True, name='celeryapp.accumulate', shared=False, lazy=False)
...
def add_unlock_chord_task(app):
    ...
    @app.task(name='celeryapp.chord_unlock', max_retries=None, shared=False,
...
def add_map_task(app):
    ...
    @app.task(name='celeryapp.map', shared=False, lazy=False)
    def xmap(task, it):
...
def add_starmap_task(app):
    ...
    @app.task(name='celeryapp.starmap', shared=False, lazy=False)
...
def add_chunk_task(app):
    ...
    @app.task(name='celeryapp.chunks', shared=False, lazy=False)
...
def add_group_task(app):
    ...
    @app.task(name='celeryapp.group', bind=True, shared=False, lazy=False)
...
def add_chain_task(app):
    """No longer used, but here for backwards compatibility."""
    @app.task(name='celeryapp.chain', shared=False, lazy=False)
...
def add_chord_task(app):
    ...
    @app.task(name='celeryapp.chord', bind=True, ignore_result=False,
