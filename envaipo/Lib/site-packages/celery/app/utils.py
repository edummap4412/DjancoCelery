...
BUGREPORT_INFO = """
software -> celeryapp:{celery_v} kombu:{kombu_v} py:{py_v}
...
class Settings(ConfigurationView):
    ...
    def find_value_for_key(self, name, namespace='celeryapp'):
    ...
    def finalize(self):
        # See PendingConfiguration in celeryapp/app/base.py
    ...
    if isinstance(sym, ModuleType) and ':' not in app:
        try:
            ...
            try:
                ...
                if isinstance(found, ModuleType):
                    raise AttributeError(
                        "attribute 'celeryapp' is the celeryapp module not the instance of celeryapp")
            except AttributeError:
