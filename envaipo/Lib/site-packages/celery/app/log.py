...
class Logging:
    ...
    def redirect_stdouts(self, loglevel=None, name='celeryapp.redirected'):
    ...
    def setup_logging_subsystem(self, loglevel=None, logfile=None, format=None,
        ...
        if not receivers:
            ...
            if self.app.conf.worker_hijack_root_logger:
                root.handlers = []
                get_logger('celeryapp').handlers = []
                get_logger('celeryapp.task').handlers = []
                get_logger('celeryapp.redirected').handlers = []
    ...
    def get_default_logger(self, name='celeryapp', **kwargs):
