...
class AsyncResult(ResultBase):
    ...
    def get(self, timeout=None, propagate=True, interval=0.5,
        ...
        Raises:
            celeryapp.exceptions.TimeoutError: if `timeout` isn't
    ...
    def collect(self, intermediate=False, **kwargs):
        ...
        .. code-block:: pycon
            ...
            >>> from celeryapp.result import ResultBase
...
class GroupResult(ResultSet):
    ...
    This type is returned by :class:`~celeryapp.group`.
