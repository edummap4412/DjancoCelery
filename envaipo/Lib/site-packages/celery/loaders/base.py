...
class BaseLoader:
    ...
    Loaders handles,
        ...
        * Reading celeryapp client/worker configurations.
    ...
    def on_worker_init(self):
        """Called when the worker (:program:`celeryapp worker`) starts."""

    def on_worker_shutdown(self):
        """Called when the worker (:program:`celeryapp worker`) shuts down."""
    ...
    def cmdline_config_parser(self, args, namespace='celeryapp',
