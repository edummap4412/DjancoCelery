...
class Node:
    ...
    def _annotate_with_default_opts(self, options):
        options['-n'] = self.name
        self._setdefaultopt(options, ['--pidfile', '-p'], '/var/run/celeryapp/%n.pid')
        self._setdefaultopt(options, ['--logfile', '-f'], '/var/log/celeryapp/%n%I.log')
...
class MultiParser:
    ...
    def __init__(self, cmd='celeryapp worker',
                 append='', prefix='', suffix='',
                 range_prefix='celeryapp'):
        self.cmd = cmd
        self.append = append
        self.prefix = prefix
        self.suffix = suffix
