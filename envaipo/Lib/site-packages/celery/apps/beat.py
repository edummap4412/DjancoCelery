...
This module is the 'program-version' of :mod:`celeryapp.beat`.
...
logger = get_logger('celeryapp.beat')
...
class Beat:
    ...
    def run(self):
        print(str(self.colored.cyan(
            f'celeryapp beat v{VERSION_BANNER} is starting.')))
        self.init_loader()
    ...
    def set_process_title(self):
        ...
        platforms.set_process_title(
            'celeryapp beat', info=' '.join(sys.argv[arg_start:]),
        )
