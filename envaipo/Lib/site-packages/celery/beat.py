...
class ScheduleEntry:
    ...
    Arguments:
        ...
        schedule (~celeryapp.schedules.schedule): see :attr:`schedule`.
    ...
    #: The schedule (:class:`~celeryapp.schedules.schedule`)
    schedule = None
    ...
    def is_due(self):
        """See :meth:`~celeryapp.schedule.schedule.is_due`."""
...
class Scheduler:
    ...
    The :program:`celeryapp beat` program may instantiate this class
    ...
    def install_default_entries(self, data):
        ...
        if self.app.conf.result_expires and \
            ...
            if 'celeryapp.backend_cleanup' not in data:
                entries['celeryapp.backend_cleanup'] = {
                    'task': 'celeryapp.backend_cleanup',
...
class Service:
    ...
    def start(self, embedded_process=False):
        ...
        if embedded_process:
            ...
            platforms.set_process_title('celeryapp beat')
    ...
    def get_scheduler(self, lazy=False,
                      extension_namespace='celeryapp.beat_schedulers'):
